...
public class ClassicsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attractions.add(new Attraction(R.string.anthem_characters,
                R.string.anthem_characters_description, R.drawable.anthem_characters));
        attractions.add(new Attraction(R.string.applied_arts_center,
                R.string.applied_arts_center_description, R.drawable.applied_atrs));
        attractions.add(new Attraction(R.string.house_of_craftsmen,
                R.string.house_of_craftsmen_description, R.drawable.house_of_craftsmen));
        attractions.add(new Attraction(R.string.peter_market, R.string.peter_market_description,
                R.drawable.peters_market));
        attractions.add(new Attraction(R.string.occupation_museum,
                R.string.occupation_museum_description, R.drawable.occupation_museum));
